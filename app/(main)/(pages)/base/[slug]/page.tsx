    ...
    <>
      <main className="h-full">
        ...
        <div className="mt-1 mb-32">
          <div className="p-10">
            <div className="diodfont-semibold text-xl text-slate-700">
              پکیج های مقطع چهارم
            </div>
            <div>
            <p className="mt-4 text-red-500 text-md diodfont-semibold text-md">
              متناسب با نیاز خود یکی از پکیج های زیر را انتخاب کرده و از آموزش لذت ببرید
            </p>
          </div>
          </div>
          ...
          <div className="grid grid-cols-12 mt-5">
            <div className="col-span-4">
              <a href="/package/1">
                <div className="w-2/3 mt-1 transition-all duration-200 hover:mt-0 mx-auto justify-center">
                  <div className="w-60">
                    <img
                      className="rounded-t-3xl w-60 h-36"
                      src="/img/gold.jpg"
                    />
                    <div className="bg-gray-300 p-4 pt-1 rounded-b-3xl">
                      <p className="flex mx-auto justify-center diodfont-semibold text-lg text-purple-800">
                        دوره طلایی
                      </p>
                      <p className="diodfont-semibold text-slate-800 text-sm">
                        شامل:
                      </p>
                      <p className="diodfont-medium text-slate-800 text-xs p-1 min-h-16">
                        تدریس ویدیویی و جامع، نمونه سوال، حل نمونه سوال به صورت
                        ویدئویی و آزمون آنلاین
                      </p>
                      {/* <div className="flex mt-2">
                        <a
                          className="diodfont-semibold rounded-lg text-xs mx-auto justify-center bg-[#37c60b] hover:bg-green-600 shadow-lg pt-1 pb-2 pr-3 pl-3"
                          href="/package/1"
                        >
                          مشاهده
                        </a>
                ...
                <div className="w-2/3 mt-1 transition-all duration-200 hover:mt-0 mx-auto justify-center">
                  <div className="w-60">
                    ...
                    <div className="bg-gray-300 p-4 pt-1 rounded-b-3xl">
                      ...
                      <p className="diodfont-medium text-slate-800 text-xs p-1 min-h-16">
                        تدریس ویدیویی و جامع و آزمون آنلاین
                      </p>
                      {/* <div className="flex mt-2">
                        <a
                          className="diodfont-semibold rounded-lg text-xs mx-auto justify-center bg-[#37c60b] hover:bg-green-600 shadow-lg pt-1 pb-2 pr-3 pl-3"
                ...
                <div className="w-2/3 mt-1 transition-all duration-200 hover:mt-0 mx-auto justify-center">
                  <div className="w-60">
                    ...
                    <div className="bg-gray-300 p-4 pt-1 rounded-b-3xl">
                      ...
                      <p className="diodfont-medium text-slate-800 text-xs p-1 min-h-16">
                        نمونه سوال و حل نمونه سوال به صورت ویدئویی
                      </p>
                      {/* <div className="flex mt-2">
                        <a
                          className="diodfont-semibold rounded-lg text-xs mx-auto justify-center bg-[#37c60b] hover:bg-green-600 shadow-lg pt-1 pb-2 pr-3 pl-3"
