    ...
    <>
      <header className="h-10 fixed top-0 left-0 w-full bg-gradient-to-l from-slate-500 to-slate-400 p-1">
        <div className="flex ml-10 mt-1 justify-between">
          <div className="text-white mr-2 text-xs diodfont-medium flex gap-2"><span>آراد عزیز، خوش آمدید</span></div>
          <div className="shadow-md">
            <a className="bg-[#FFF500] rounded-xl pb-1 ml-2 pr-5 pl-5 text-xs diodfont-semibold" href="/">
              صفحه اصلی
            </a>
